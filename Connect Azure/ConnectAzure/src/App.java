...
public class App {
    public static void main(String[] args) throws Exception {
        try{
            Connection SQlCnn = DriverManager.getConnection("jdbc:sqlserver://dbsthomas.database.windows.net:1433;database=premiere;user=thomas@dbsthomas;password=1dbserver!;encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;");
            ...
            String SQL = "select * from part order by description";
